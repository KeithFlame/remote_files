...
p8 = p7 - [0 3 0]';
% chain1
joint_unit1 = MotionUnit(p0(:,1), p1(:,1), p2(:,1), 3);
joint_unit2 = MotionUnit(p2(:,1), p3(:,1), p4(:,1), 2);
...
joint_unit3 = MotionUnit(p4(:,2), p3(:,2), p2(:,2), 2);
joint_unit4 = MotionUnit(p2(:,2), p1(:,2), p0(:,2), 3);
...
joint_unit3 = MotionUnit(p4(:,3), p3(:,3), p2(:,3), 2);
joint_unit4 = MotionUnit(p2(:,3), p1(:,3), p0(:,3), 3);
