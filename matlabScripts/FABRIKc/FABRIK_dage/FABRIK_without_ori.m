function [flag,iter]=FABRIK_without_ori(target)
...
pc1=planar_continuum(0.1,100,[0;0],eye(2),[0.8,0,0]);
pc2=planar_continuum(-0.1,100,pc1.endtip,eye(2),[0,0.8,0]);
...
%     frame_num=frame_num+1;
    ...
    if norm(target-pc(end).endtip)<=0.01
        break
    end
