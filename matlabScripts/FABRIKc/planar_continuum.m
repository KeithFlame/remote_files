    ...
    methods
        ...
        function obj=planar_continuum(theta,length,origin,rotation,arc_color)
            if nargin<5
              ...
              obj.length=100;
              obj.origin=[0;0;0];
              obj.endtip=[0;0;obj.length];
              obj.rotation=[1,0,0;0,1,0;0,0,1];
...
%               obj.tangent_length=obj.length/2;
        ...
        function obj=variable_com(obj)
            if obj.theta==0
                obj.tangent_length=obj.length/2;
                obj.virtual_joint=obj.origin+obj.rotation*[0;0;obj.tangent_length];
            else
            ...
            obj.delta = obj.rotation*[cos(-obj.theta), -sin(-obj.theta); sin(-obj.theta),cos(-obj.theta)];
            
            if obj.theta==0
                obj.endtip=obj.origin+obj.rotation*[0;0;obj.length];
              else
