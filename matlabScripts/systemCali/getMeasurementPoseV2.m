...
Ttrocar_marker_proximal=zeros(4,4,block_size);
Ttrocar_marker_rural=zeros(4,4,block_size);
...
for i =1:block_size
    ...
    %
    quat1=M(i*2-1,[4 5 6 7]);
    quat1=quat1/norm(quat1);
    Rtrocar_marker_proximal=quat2rotm(quat1);
    Ttrocar_marker_proximal(:,:,i)=inv(Tcamera_trocar)*[Rtrocar_marker_proximal P_tem_1';0 0 0 1 ];
    quat2=M(i*2,[4 5 6 7]);
    quat2=quat2/norm(quat2);
    Rtrocar_marker_rural=quat2rotm(quat2);
    Ttrocar_marker_rural(:,:,i)=inv(Tcamera_trocar)*[Rtrocar_marker_rural P_tem_2';0 0 0 1 ];
...
save(fname,'Ttrocar_marker_proximal');
fname=['./test1102/pose_new/Ttrocar_marker_r_data_',name];
save(fname,'Ttrocar_marker_rural');
