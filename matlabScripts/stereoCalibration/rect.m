...
cam_no = 57;
partialPath=pwd;
folderPath = [partialPath,'/D0410NO65XX',num2str(cam_no)];
...
params.intrinsic2=[1084.210226	0	957.9554986;
                    0	1089.750209	538.1569051;
                        0	0	1
];
...
for y=1080:-1:900
    w=int16(y/9*16/2);
    left_start =[1080 - int16(y/2), 1920 - w];%left ROI is equal to right one
...
%  y=1080;
left_start =[1080 - int16(y/2), 1920 - int16(y/9*16/2)];
right_start =[1080 - int16(y/2), 1920 - int16(y/9*16/2)];

 left_start1 =[int16(v0) - 540, int16(u0) - 960];
 right_start1 =[int16(v0) - 540, int16(u0) - 960];
...
I1_crop = I1_rect(left_start(1):left_start(1)+y-1,...
    left_start(2):left_start(2)+int16(y/9*16)-1,:);
I2_crop = I2_rect(right_start(1):right_start(1)+y-1,...
    right_start(2):right_start(2)+int16(y/9*16)-1,:);
...
line([left_start(2) + int16(y/9*16), left_start(2) + int16(y/9*16)],...
    [left_start(1),left_start(1) + y],'color','g');
line([left_start(2),left_start(2) + int16(y/9*16)],...
...
line([r_start(2) + int16(y/9*16), r_start(2) + int16(y/9*16)],...
    [r_start(1),r_start(1) + y],'color','g');
line([r_start(2),r_start(2) + int16(y/9*16)],...
