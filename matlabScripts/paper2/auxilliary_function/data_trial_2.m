p0=load("F:\code_git\matlabScripts\paper2\data_process\pic_factory\t2g/cur_data_2.log");
p=p0(:,1:3);
r=p0(:,4:7);
pr=p0(:,1:7);
block_size = size(p,1);
