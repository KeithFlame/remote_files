function [Rsd,MBP,t0,y0,t1,y1,t2,y2,t3,y3,QA]=forInvShooting2_keith(Guess,T,ksi,MBP)
% do an IVP shooting
...
Rsd(19:21)=invSkewMatrix_keith(R12_*R13'-R13*R12_');
Rsd(22:24)=dot((y12(1:3)-y13(1:3))',R13(:,3))*R13(:,3);

QA = zeros(12,1);
QA(1:6)=[Guess(7:8)+[0 0.06]';yL11_(19:20)-qe11;yL12_(19:20)-qe12];
QA(7:12)=[Guess(19:20)+[0 0.08]';yL21_(19:20)-qe21;yL22_(19:20)-qe22];
end