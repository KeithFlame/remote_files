...
init_K1=5;
ksi1=zeros(5,1);ksi2=zeros(5,1);
ksi1(1:4)= Guess(21:24).*init_ksi+init_ksi;ksi1(5)=Guess(25);
ksi2(1:4)= Guess(26:29).*init_ksi+init_ksi;ksi2(5)=Guess(30);

MBP1 = MBP(1);
MBP2 = MBP(2);
MBP1 = MBP1.resetK1(Guess(31)*init_K1+init_K1);
MBP2 = MBP2.resetK1(Guess(32)*init_K1+init_K1);
MBP1 = MBP1.refreshLso(qa(2)*1000);
MBP2 = MBP2.refreshLso(qa(8)*1000);
MBP = [MBP1 MBP2];

ksi=[ksi1;ksi2;MBP1.K1;MBP2.K1;];
[T10,T20] = getT12;
[dr1,dr2]=setDR12;
...
R11=[y11(4:6);y11(7:9);y11(10:12)]'; % R1e
ynew=y11';ynew(1:3)=ynew(1:3)+R11*[0 0 MBP1.Lr]'; % move from 1e to 2b
ynew(16:18)=ynew(16:18)+cross(R11*[0 0 MBP1.Lr]',ynew(13:15))...
...
R12=[y12(4:6);y12(7:9);y12(10:12)]'; % R2e
ynew=y12';ynew(1:3)=ynew(1:3)+R12*[0 0 MBP1.Lg]'; % move from 2e to g
ynew(16:18)=ynew(16:18)+cross(R12*[0 0 MBP1.Lg]',ynew(13:15))...
...
R21=[y21(4:6);y21(7:9);y21(10:12)]'; % R1e
ynew=y21';ynew(1:3)=ynew(1:3)+R21*[0 0 MBP2.Lr]'; % move from 1e to 2b
ynew(16:18)=ynew(16:18)+cross(R21*[0 0 MBP2.Lr]',ynew(13:15))...
...
R22=[y22(4:6);y22(7:9);y22(10:12)]'; % R2e
ynew=y22';ynew(1:3)=ynew(1:3)+R22*[0 0 MBP2.Lg]'; % move from 2e to g
ynew(16:18)=ynew(16:18)+cross(R22*[0 0 MBP2.Lg]',ynew(13:15))...
...
Rsd(10:12)=invSkewMatrix_keith(Rrsd*R13'-R13*Rrsd')/10;
Rsd(13:15)=(Prsd - yL23(1:3));
Rrsd2 = Rrsd*eul2rotm([0 pi 0]);
Rsd(16:18)=invSkewMatrix_keith(Rrsd2*R23'-R23*Rrsd2')/10;
