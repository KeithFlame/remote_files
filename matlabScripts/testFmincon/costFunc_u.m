...
if(Ls>0)
    ...
    u1o=[0 theta1o/L1 0]';
%     theta1_b=L1/(Ls*SP.zeta+L1)*theta1;
%     thetas_b=Ls*SP.zeta/(Ls*SP.zeta+L1)*theta1;
%     u1_b=[0 theta1_b/L1 0]';
%     us_b=[0 thetas_b/Ls 0]';

%     f=us'*Ks*usi+(uso-us_b)'*Ks*(uso-us_b)+(u1o-u1_b)'*K1*(u1o-u1_b);
...
%     u1_b=[0 theta1/(SP.l-SP.L2-SP.Lr) 0]';
    if(dsi<1e-5)
        ...
        u1i=[0 sin(theta1i)/d 0]';
        L1o=SP.l-SP.L2-SP.Lr+d-d/sin(theta1i)*theta1i;
        u1o=[0,theta1o/L1o 0]';
        f=u1i'*K1*u1i+(u1o)'*K1*(u1o);
        if(theta1i>1e-6)
