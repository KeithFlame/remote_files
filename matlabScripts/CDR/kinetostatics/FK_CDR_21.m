...
guess = [target;n1_0;m1_0;n1_1;m1_1;n2_0;m2_0;n2_1;m2_1;n3_0;m3_0;n3_1;m3_1];
% load('matlab.mat');
%积分全部支链
...
points_1 = 1000 * R1_1 * [ys1(1:2,:);zeros(1,block_size)];
points_2 = 1000 * R2_1 * [ys2(1:2,:);zeros(1,block_size)];
...
%     tic
    ...
    guess = guess - ((jacobian'*jacobian+damp*eye(size(jacobian)))\jacobian' * res)*step_keith;
    %积分全部支链
...
% 各支链多腔管力矩平衡
error_m_1 = -cross(P_1_1,n_1_1) + cross(P_1_2,n_1_2) - m_1_1 + m_1_2 + cross(P_1_tran,G_m_1);
error_m_1 = error_m_1(3);
error_m_2 = -cross(P_2_1,n_2_1) + cross(P_2_2,n_2_2) - m_2_1 + m_2_2 + cross(P_2_tran,G_m_2);
error_m_2 = error_m_2(3);
error_m_3 = -cross(P_3_1,n_3_1) + cross(P_3_2,n_3_2) - m_3_1 + m_3_2 + cross(P_3_tran,G_m_3);
...
% % % % % % % % G_tran_1 =  G_tran;
% % % % % % % % 
% % % % % % % % m_1_2 = cross(P_1_1,n_1_1)-cross(P_1_2,n_1_2)+m_1_1-cross(P_1_tran,G_tran_1);
% % % % % % % % m1=m_1_2(3);
...
proximal_1 = points_1(:,1:s1);
distal_1 = points_1(:,s2:s3);

proximal_2 = points_2(:,1:s1);
distal_2 = points_2(:,s2:s3);

proximal_3 = points_3(:,1:s1);
distal_3 = points_3(:,s2:s3);
...
plot3(x_n_1,y_n_1,z_n_1,'r-.','linewidth',guide_width);
plot3(x_1,y_1,z_1,'r','linewidth',3);

plot3(x_n_2,y_n_2,z_n_2,'g-.','linewidth',guide_width);
plot3(x_2,y_2,z_2,'g','linewidth',3);

plot3(x_n_3,y_n_3,z_n_3,'b-.','linewidth',guide_width);
plot3(x_3,y_3,z_3,'b','linewidth',3);

%绘制连续体支链1
plot3(proximal_1(1,:),proximal_1(2,:),proximal_1(3,:),'r','linewidth',continuum_width);
plot3(distal_1(1,:),distal_1(2,:),distal_1(3,:),'r','linewidth',continuum_width);
plot3([proximal_1(1,end);distal_1(1,1)],[proximal_1(2,end);distal_1(2,1)],[proximal_1(3,end);distal_1(3,1)],'k','linewidth',continuum_width);

%绘制连续体支链2
plot3(proximal_2(1,:),proximal_2(2,:),proximal_2(3,:),'g','linewidth',continuum_width);
plot3(distal_2(1,:),distal_2(2,:),distal_2(3,:),'g','linewidth',continuum_width);
plot3([proximal_2(1,end);distal_2(1,1)],[proximal_2(2,end);distal_2(2,1)],[proximal_2(3,end);distal_2(3,1)],'k','linewidth',continuum_width);

%绘制连续体支链3
plot3(proximal_3(1,:),proximal_3(2,:),proximal_3(3,:),'b','linewidth',continuum_width);
plot3(distal_3(1,:),distal_3(2,:),distal_3(3,:),'b','linewidth',continuum_width);
plot3([proximal_3(1,end);distal_3(1,1)],[proximal_3(2,end);distal_3(2,1)],[proximal_3(3,end);distal_3(3,1)],'k','linewidth',continuum_width);
