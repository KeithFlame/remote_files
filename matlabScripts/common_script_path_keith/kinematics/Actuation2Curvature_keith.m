...
%
% input1: qa the actuation variables (6 X 1 vector).
...
% output: u curvature of the 2-seg continuum manipulator (6 X 1 vector).
%
%
% Author: Keith W.
% Ver. 1.0
...
if(nargin == 2 || isempty(MBP))
    ...
    MBP.G=MBP.E/2/(1+MBP.mu);
    MBP.J1=2*MBP.I1;MBP.J2=2*MBP.I2;
