...
% % % %     MBP.I2=pi*MBP.d2^4/64;MBP.A2=pi*MBP.d2^2/4 * 4;
% % % %     MBP.G=MBP.E/2/(1+MBP.mu);MBP.J=2*MBP.I1;
% % % %     MBP.Ke1=diag([MBP.G*MBP.A1 MBP.G*MBP.A1 MBP.A1*MBP.E]);
% % % %     MBP.Ke2=diag(1*[MBP.G*MBP.A2 MBP.G*MBP.A2 MBP.A2*MBP.E]);
% % % %     
% % % %     MBP.Kb1=diag([MBP.E*MBP.I1 MBP.E*MBP.I1 2*MBP.G*MBP.I1]);
% % % %     MBP.Kb2=1*diag([MBP.E*MBP.I2 MBP.E*MBP.I2 2*MBP.G*MBP.I2]);
% % % %     MBP.zeta = 0.2;
% % % %     MBP.L1o = MBP.L1;
% % % %     MBP.Lo = MBP.L;
% % % %     MBP.Ls=0;
...
% % % % 
% % % % K(1:3,1:3)=4*MBP.Kb1+16*MBP.Kb2+MBP.K1*MBP.Kb1;
% % % % K(1:3,4:6)=-16*MBP.Kb2-MBP.K2*MBP.Kb1;
% % % % K(4:6,4:6)=16*MBP.Kb2+MBP.K2*MBP.Kb1;
% % % % 
