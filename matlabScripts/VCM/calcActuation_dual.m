function [qa]=calcActuation_dual(u1,u2,L0,MP)
...
u3=pinv(MP.Q2')/MP.alpha/MP.L3*( MP.Q2'*(MP.L1+MP.gamma*MP.L0)*u1+(MP.Q2'*MP.L2+ (MP.L2+MP.Lr+MP.L1+MP.L+MP.Lc+MP.L3)/MP.A2/MP.E*pinv(MP.Q2)*16*MP.Kb2)*u2 );
u=[u1;u2;u3];
