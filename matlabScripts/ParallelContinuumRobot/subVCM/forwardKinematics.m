...
MP.d2=0.40e-3;
MP.rho1=2.5e-3;%Rod pitch circle radius
MP.rho2=2.7e-3;%Rod pitch circle radius
MP.L=660e-3;%Robot stem length
MP.L1=40e-3;%Robot seg1 length
MP.L2=20e-3;%Robot seg2 length
MP.Lr=10e-3;%Robot rigid seg length
MP.Lg=15.0e-3;%Robot gipper length
MP.r11=[1 0 0]'*MP.rho1;MP.r12=[0 1 0]'*MP.rho1;
MP.r21=[1/sqrt(2) 1/sqrt(2) 0]'*MP.rho2;MP.r22=[-1/sqrt(2) 1/sqrt(2) 0]'*MP.rho2;
...
MP.Ke2=diag(4*[3e8 3e8 MP.A2*MP.E]);MP.Kb2=diag(4*[MP.E*MP.I2 MP.E*MP.I2 10]);

% specify actuation length and external loads
kkr = 2.7/2;
qa=kkr*[0 0 ...
    0 0 ...
    pi/2/sqrt(2)  -pi/2/sqrt(2) ]'.*[0,0,MP.rho1,MP.rho1,MP.rho2,MP.rho2]'; % PHI D 
